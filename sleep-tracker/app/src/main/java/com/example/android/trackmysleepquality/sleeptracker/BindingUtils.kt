...
// there is also a way to create a custom ImageView class
// class SleepImageView() : ImageView() {
//     fun setSleepImage(item: SleepNight) {
//         // ...
//     }
// }
...
fun TextView.setSleepDuratinFormatted(item: SleepNight?) {
    item?.let {
        text = convertDurationToFormatted(
            startTimeMilli = item.startTimeMilli,
            endTimeMilli = item.endTimeMilli,
